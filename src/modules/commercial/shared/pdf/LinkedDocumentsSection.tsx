/**
 * Componente PDF compartido para renderizar documentos vinculados
 * Se usa en todos los templates de PDF cuando el usuario elige incluir registros asociados
 */
        ...
        <View key={sIdx} style={ldStyles.section}>
          ...
          <View style={ldStyles.tableHeader}>
            <View style={ldStyles.colLabel}>
              <Text style={ldStyles.headerText}>{section.columns[0] || 'Documento'}</Text>
            </View>
            {section.columns[1] && (
